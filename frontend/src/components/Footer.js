  ...
  return (
    <footer className="footer mb-2">
      <Container className="pt-4">
          ...
          <Col sm={12} md={4} lg={3}>
            ...
            <Row className="justify-content-around">
              ...
              <Button className="linkedin-button">
                <a href="https://www.linkedin.com/in/training-and-placement-cell-foet-university-of-lucknow-a3474a1b1">
                  <LinkedIn />
                </a>
              </Button>
        ...
        <Col>
          <div className="text-center">&copy; 2021 TnP, FoET. All Rights Reserved</div>
